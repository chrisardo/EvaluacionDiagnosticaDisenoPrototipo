...
<script>
    ...
    var myChart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label: ['Nivel de logro de las capacidades'],
                data: [
                    <?php
                    $sql_competencias = mysqli_query($mysqli, "SELECT*FROM competencias WHERE id_asignatura='2' ");
                    ...
                    foreach ($competencias as $row_c) {
                        ...
                        $sql_resumen3 = mysqli_query($mysqli, "SELECT resumen_evaluacion.id_competencia, resumen_evaluacion.id_nivel id_nivel_re, SUM(resumen_evaluacion.porcentaje) porcentaje, 
                            ...
                            where resumen_evaluacion.cod_mod_ie='$cod_mod_ie' and resumen_evaluacion.id_competencia='$id_compe'
